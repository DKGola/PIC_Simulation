...
public class InterruHandler {
    ...
    private void incrementTRM0() {
        ...
        if (ram[0][1] > 255) {
            ...
            if (execute.getFlag(Flags.TimerInterrupt) == 1 && execute.getFlag(Flags.GlobalInterruptEnable) == 0) {
                // Timer Interrupt
    ...
    public void CheckInterrupt(){
        ...
        if(RB7ToRB4 != previousRB7ToRB4){
            ...
            if(execute.getFlag(Flags.RBPortChangeEnable) == 1 && execute.getFlag(Flags.GlobalInterruptEnable) == 1){
    ...
    private void RB0Interrupt(){
        ...
        if(execute.getFlag(Flags.GlobalInterruptEnable) == 1 && execute.getFlag(Flags.RB0InterruptEnable) == 1){
            execute.setFlag(Flags.GlobalInterruptEnable, 0);
            execute.returnStack.push(Simulator.programCounter);
            Simulator.programCounter = 4;
        }
